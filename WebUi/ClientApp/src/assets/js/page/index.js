...
$(function () {
    ...
    /* area line chart */
    var chart = document.getElementById('SMS_Statistics_Line');
    ...
    lineChart.setOption({
        ...
        legend: {
        textStyle: {color: '#9aa0ac'},
            data: ["Last Week", "Last Month", "Last Three Month"]
        },
        toolbox: {
            show: !1
        },
	...
	/* area line chart */
    var chart = document.getElementById('CALL_Statistics_Line');
    var lineChart = echarts.init(chart);
	...
	var chart = document.getElementById('echart_bar2');
    var barChart = echarts.init(chart);
